...
- [ ] Matches existing site grid and spacing
- [ ] Figma link added to this issue before moving to dev

## App & Repo
- **App:** Bread Coop Landing
- **Repo:** BreadchainCoop/breadcoop-landing
